...
<html lang="en">
    ...
    <body>
        ...
        <div class="center">
        <h1>Please choose the department you wish to log into</h1>
        <form method="post" action="PageControl" id="form">
            <div class ="btn_view_site"><a href="EmployeeLogin.jsp">Employees</a></div>
            <div class ="btn_view_site"><a href="PartnerLogin.jsp">Partners</a></div>
        </form>
        </div>
    </body>
