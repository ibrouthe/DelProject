<%-- 
    Document   : selectedEmployee
    Created on : Apr 29, 2015, 10:22:18 AM
    Author     : TOcvfan
--%>
...
<html lang="da">
    ...
    <body>
        ...
        <%
            ...
            selEmp = (Employee) session.getAttribute("clickedEmployee");
            int empID = selEmp.getEmpID();
            String empName = selEmp.getEmpName();
            int status = selEmp.getEmpStatus();
            String eMail = selEmp.getEmpMail();
            String empPass = selEmp.getEmpPass();
        ...
        <section id="main" class="column">
            <article class="module width_full">
                <header><h3><%out.println(em.getEmpName());%></h3></header>
                <div class="module_content">

                    <div id="list">

                        
                        <h5>ID: <%out.println(em.getEmpID());%></h5>
                        <h5>eMail: <%out.println(em.getEmpMail());%></h5>
                        <h5>Status: <%out.println(em.getEmpStatus());%></h5>
